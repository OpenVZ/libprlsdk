...
typedef enum _PRL_HANDLE_TYPE
{
	...
	PHT_BACKUP						= 0x10000063,

	PHT_LAST = PHT_BACKUP // should be set to last
} PRL_HANDLE_TYPE;
...
typedef enum _PRL_TIS_RECORD_FIELD
{
	...
	PTIS_RECORD_CLEARED		= 1U << 31, // set only with PTIS_RECORD_REMOVED bit
...
typedef enum _PRL_CPU_FEATURES_EX
{
	...
	PCFE_EXT_00000007_EDX = 8,
	PCFE_EXT_00000007_ECX = 9,
...
enum _PRL_PASSWD_LENGTH
{
	MAX_PASSWORD_LENGTH = 1024,
	MAX_ENCODED_PASSWORD_LENGTH = 4 * ((MAX_PASSWORD_LENGTH + 2) / 3),
};

/**
 * Chipset
 */
typedef enum _PRL_CHIPSET_TYPE
{
	CHIP_UNKNOWN = 0,
	CHIP_MIN_NUMBER = 1u,
	CHIP_PCI440FX = CHIP_MIN_NUMBER,
	CHIP_Q35 = 2u,
	CHIP_RHEL7 = 3u,
	CHIP_MAX_NUMBER = CHIP_RHEL7,

} PRL_CHIPSET_TYPE;
typedef PRL_CHIPSET_TYPE* PRL_CHIPSET_TYPE_PTR;

typedef enum PRL_I440FX_VERSION
{
	PCI440FX_78 = 5u,
	PCI440FX_710 = 7u,
	PCI440FX_712 = 9u,
