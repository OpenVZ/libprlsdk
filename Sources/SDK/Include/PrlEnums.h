...
typedef enum _PRL_HANDLE_TYPE
{
	...
	PHT_CPU_FEATURES_MASK							= 0x1000005D,

	PHT_LAST = PHT_CPU_FEATURES_MASK // should be set to last
} PRL_HANDLE_TYPE;
...
typedef enum _PRL_CPU_FEATURES_MASK_EX
{
	PCFM_FEATURES_MASK = 0,
	PCFM_EXT_FEATURES_MASK = 1,
	PCFM_EXT_00000007_EBX_MASK = 2,
	PCFM_EXT_80000001_ECX_MASK = 3,
	PCFM_EXT_80000001_EDX_MASK = 4,
	PCFM_EXT_80000007_EDX_MASK = 5,
	PCFM_EXT_80000008_EAX = 6,
} PRL_CPU_FEATURES_MASK_EX;
