...
typedef struct _PRL_CPU_FEATURES_MASK
{
	...
	// @brief 00000007 ecx mask
	PRL_UINT32 nEXT_00000007_ECX_MASK;
	// @brief 00000007 edx mask
	PRL_UINT32 nEXT_00000007_EDX_MASK;
...
typedef struct _PRL_CPU_FEATURES
{
	...
	// @brief 00000007 ecx
	PRL_UINT32 nEXT_00000007_ECX;
	// @brief 00000007 edx
	PRL_UINT32 nEXT_00000007_EDX;
	// @brief 80000001 ecx
