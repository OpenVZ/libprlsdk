/*
 * PrlHandleVmDeviceGenericScsi.h
 *
...
#ifndef __VIRTUOZZO_HANDLE_VM_DEVICE_GENERIC_SCSI_H__
#define __VIRTUOZZO_HANDLE_VM_DEVICE_GENERIC_SCSI_H__


#include "PrlHandleVmDevice.h"

/**
 * Generic SCSI VM device handle object.
 */
class PrlHandleVmDeviceGenericScsi : public PrlHandleVmDevice
{
...
public:
	 ...
	 */
	PrlHandleVmDeviceGenericScsi( const PrlHandleVmPtr &pVm, class CVmGenericScsiDevice *pGenericScsi = 0 );
...
private:
	...
	class CVmGenericScsiDevice *m_pVmGenericScsi;
...
private:
	...
	/**
	 * Overridden method that returns pointer to VM mass storage device XML model object
	 * @param return code that should be correctly filled
	 */
...
#endif // __VIRTUOZZO_HANDLE_VM_DEVICE_GENERIC_PCI_H__
