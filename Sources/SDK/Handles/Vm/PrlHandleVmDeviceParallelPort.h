/*
 * PrlHandleVmDeviceParallelPort.h
 *
...
#ifndef __PARALLELS_HANDLE_VM_DEVICE_PARALLEL_PORT_H__
#define __PARALLELS_HANDLE_VM_DEVICE_PARALLEL_PORT_H__


#include "PrlHandleVmDevice.h"

/**
 * Parallel port VM device handle object.
 */
class PrlHandleVmDeviceParallelPort : public PrlHandleVmDevice
{
...
public:
	 ...
	 */
	PrlHandleVmDeviceParallelPort( const PrlHandleVmPtr &pVm, class CVmParallelPort *pParallel = 0 );
...
private:
	...
	class CVmParallelPort *m_pVmParallelPort;
...
#endif // __PARALLELS_HANDLE_VM_DEVICE_PARALLEL_PORT_H__
