/*
 * PrlHandleVmDeviceOpticalDisk.h
 *
...
/**
 * Optical disk VM device handle object.
 */
class PrlHandleVmDeviceOpticalDisk : public PrlHandleVmDevice
{
...
public:
	 ...
	 */
	PrlHandleVmDeviceOpticalDisk( const PrlHandleVmPtr &pVm, class CVmOpticalDisk *pOpticalDisk = 0 );
...
private:
	...
	class CVmOpticalDisk *m_pVmOpticalDisk;
