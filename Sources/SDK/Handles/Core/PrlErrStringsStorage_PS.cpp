 ...
 * Parallels Server and should be included to PrlErrStringsStorage
 * class body.
 *
...
void PrlErrStringsStorage::InitializePSErrorMessages()
{
	...
	REGISTER_ERROR_STRING(
		...
		tr("The configuration was not saved. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Not enough disk space on the physical server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Install the USB device driver or contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Access denied."),
		tr("You do not have enough rights to use this virtual machine. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("An unexpected error occurred while starting the virtual machine. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Select another location or contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Access denied."),
		tr("You do not have the permission to use this virtual machine and perform any actions with it until you have the proper access privileges. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The changes you did to the virtual machine configuration will be discarded. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server was successfully activated."),
		QString(),
		false,
		PMT_INFORMATION
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Attention! Parallels Server is going to update your virtual machine to a new format."),
	...
	REGISTER_ERROR_STRING(
		...
		tr("No suitable adapter for the specified network type could be found. Check your network settings using <b>Server > Edit settings > Network</b> or contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to start the virtual machine \"%1\"."),
		tr("The virtual machine cannot be started because the hardware virtualization support is disabled in the physical server BIOS settings. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The folder required for the correct operation of Parallels Server is not available."),
		tr("Contact your Parallels Server administrator for assistance or try to reinstall the application."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The file does not exist or you do not have the permission to delete it. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server virtual machine configuration files must have the \".pvs\" extension. Select the correct file and try again."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to start the virtual machine."),
		tr("The virtual machine cannot be started. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The necessary authorization file could not be created because your physical hard disk is full. Free some disk space and try again or contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The specified network adapter cannot be installed on this server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The specified network adapter cannot be removed. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The system error %1 occurred when applying the new settings. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Check your network settings and try again. If the problem persists, contact your Parallels Server administrator." ),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server detected that the structure of the virtual hard disk %1 is corrupt. This may cause your virtual machine and its applications to work incorrectly. Use the disk checking utilities inside the virtual machine to repair the disk."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You are not allowed to create folders in this location. Choose another location or contact the Parallels Server administrator."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Purchase a new <a href=\"http://www.parallels.com/en/shop/online/server/\">activation key</a> to continue using Parallels Server."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You need to quit %1 to be able to start virtual machines with Parallels Server."),
	...
	REGISTER_ERROR_STRING(
		...
		tr("You do not have the permission to write to the folder %2. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The default network adapters on this server cannot be reinstalled properly. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The selected object was opened for editing incorrectly. Try to open the object again or contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The user session was established incorrectly. Try to establish a new session or contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to connect to Parallels Server."),
		tr("You may experience a connection problem or the server may be down. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You need to restart Parallels Server on the physical server."),
		tr("The new settings will come into effect only after the Parallels Server restart."),
		false,
		PMT_INFORMATION
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("One or more kernel components loaded on your server are for another version of Parallels Server. If you start the virtual machine now, it may work incorrectly. To solve this problem, restart your server. If the problem persists, reinstall Parallels Server."),
		false,
		PMT_QUESTION
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You will not be able to start the virtual machine until you disable or remove the Intel-d device from its configuration. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	PRL_ERR_VTD_ALREADY_HOOKED_FAILED,
		tr("The virtual machine cannot be started."),
		tr("The Intel VT-d PCI device is already in use in another virtual machine. You will not be able to start this virtual machine until you disable or remove the device from its configuration. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	PRL_ERR_VTD_HOOK_FAILED,
		tr("The virtual machine cannot be started."),
		tr("Parallels Server could not gain control over the Intel VT-d PCI device connected to this virtual machine. You will not be able to start the virtual machine until you disable or remove the device from its configuration. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The virtual machine is not registered in the virtual machine directory on this server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
  ...
  REGISTER_ERROR_STRING(
		...
		tr("The virtual machine cannot be started."),
		tr("You cannot run a 64-bit virtual machine on a 64-bit physical server if the server does not support hardware virtualization or has the hardware virtualization option disabled in its BIOS settings. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The name of this network adapter could not be changed. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("There may be connection problems or the server may be down. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	PRL_ERR_VTD_HOOK_NEED_REBOOT_FAILED,
		tr("Unable to start the virtual machine."),
		tr("The Intel VT-d support is disabled on this server. Restart the server and try again. If the problem persists, contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The virtual machine %1 cannot be resumed because the file containing its saved state is incompatible with this version of Parallels Server. If you restart the virtual machine now, you will lose this saved state."),
		false,
		PMT_QUESTION
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You do not have the permission to write to the file \"%2\". Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("An invalid response has been received from the server. Make sure that Parallels Server is running on the server \"%1\" and is up to date and try again."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to connect to the server \"%1\"."),
		tr("The version of your Parallels Server software <i>%2</i> is incompatible with the version of Parallels Server installed on the physical server <i>%3</i>. Synchronize the Parallels Server software on both servers and try again."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to connect to the server \"%1\"."),
		tr("The SSL authentication failed. Try to connect to the server again. If the problem persists, contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Make sure that the connection to the respective physical server is established, you have the necessary permissions for the virtual machine, and the virtual machine files are present on the server's hard disk. If the problem persists, contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("To set these options, you need to have administrator privileges for this server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("To enable or disable verbose logging, you need to have administrator rights for this server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("You do not have the necessary permissions to perform this operation. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server is shutting down. Try again later."),
		false,
		PMT_CRITICAL);
...
///// Config validation ///////////////////////////////////////////////////////
	...
	REGISTER_ERROR_STRING(
		...
		tr("Specify a guest operating system that is supported in Parallels Server and try again."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Specify a guest operating system version that is supported in Parallels Server and try again."),
		false,
		PMT_WARNING
		);
...
////////////////////////////////////////////////////////////////////////////////
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server cannot set the required permissions for one or more objects in the virtual machine folder. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server cannot set the required access permissions for one or more objects in the virtual machine folder. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server cannot allocate enough memory for running the virtual machine. Suspend or stop one or more of the virtual machines currently running on the server and try again. If the problem persists, contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server does not support using virtual machine files located on a network share. Select a path on your local disk and try again."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("This is a VLAN interface. The current version of Parallels Server does not support using VLAN interfaces for bridged networking."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("There is not enough memory or disk space for the virtual machine to work correctly. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Parallels Server was unable to send data to the hypervisor driver. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL);
	...
	REGISTER_ERROR_STRING(
		...
		tr("The virtual machine permissions could not be changed because some of its files are stored on a network location. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL);
	...
	REGISTER_ERROR_STRING(
		...
		tr("Unable to complete the operation."),
		tr("This type of devices is not supported in Parallels Server."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("An error occurred while starting the iPhone service. Try to restart the physical server. If the problem persists, reinstall Parallels Server or contact your Parallels Server administrator for assistance."),
		false,
		PMT_WARNING
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("This product could not be activated because your activation key is invalid for this version of Parallels Server."),
	...
	REGISTER_ERROR_STRING(
		...
		tr("This iSCSI storage is not registered on this server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("This iSCSI storage mount point already registered on server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
	...
	REGISTER_ERROR_STRING(
		...
		tr("This iSCSI storage mount point already exists on server. Contact your Parallels Server administrator for assistance."),
		false,
		PMT_CRITICAL
		);
